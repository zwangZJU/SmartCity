...
public class CircleRefreshLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setAttrs(attrs);
        mPullHeight = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 100, context.getResources().getDisplayMetrics());
    ...
    private void setUpChildAnimation() {
        ...
        mUpTopAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mChildView != null) {
                    mChildView.setTranslationY(val);
                    Log.d(TAG, "onAnimationUpdate: " + val);
                }
                mHeader.getLayoutParams().height =(int)Math.max(val-10,0) ;
